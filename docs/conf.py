# -*- coding: utf-8 -*-
#
# gridfinder documentation build configuration file
#
...
def linkcode_resolve(domain, info):
    link_prefix = "https://gitlab.aai.lab//customers/tfe/vida/gridfinder/blob/develop"
    if domain != "py":
        return None
    if not info["module"]:
        return None
...
htmlhelp_basename = "gridfinder_doc"
...
man_pages = [("index", "gridfinder", "", ["appliedAI and Chris Ardene"], 1)]
